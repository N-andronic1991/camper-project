          ...
          <ul>
            <li>
              <p className={css.text}>
                ...
                equipment from trusted providers near you. Whether it is a tent,
                a kayak, or a camper van, you can rent everything you need for
                your next adventure.
              </p>
            </li>
            <li>
            ...
            <li>
              <p className={css.text}>
                <b>Sell:</b> Got gear that you no longer need? List your items
                on CamperTrade and connect with a community of outdoor
                enthusiasts who are looking for exactly what you have to offer.
                It is a sustainable way to pass on the joy of adventure while
                earning extra cash.
              </p>
            </li>
          </ul>
